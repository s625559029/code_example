...
/***
/* This file reveals the framework of Player class in 2D game, it includes update, draw, and movements of Player;
/* The code is clean and readable, comments nicely explain the function of each part;
/* Implemented Object Pool for bullets to improve memory efficiency.
***/
...
void Player::update(Uint32 ticks) {
    ...
    if(lives > 0) {
	//Switch left image and right image
        if (getVelocityX() > 0) {
            images = imagesRight;
